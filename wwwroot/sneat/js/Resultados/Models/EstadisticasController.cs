...
//         public async Task<ActionResult<IEnumerable<FechaActividadDTO>>> FechaTipoActividad()
//         {
//             var actividades = await _context.Actividades
//             .Include(a => a.TipoActividad)
//             .Include(a => a.Persona)
...
//             List<FechaActividadDTO> actividadMostrar = new List<FechaActividadDTO>();
//             foreach (var actividad in actividades)
//             {
//                 var fechaExistente = actividadMostrar.Where(a => a.Fecha == actividad.Fecha).SingleOrDefault();
//                 if (fechaExistente == null)
//                 {
//                     fechaExistente = new FechaActividadDTO
//                     {
//                         Fecha = actividad.Fecha,
//                         TiposActividad = new List<TipoActividadDTO>()
//                     };
//                     actividadMostrar.Add(fechaExistente);
//                 }
//                 var tipoExistente = fechaExistente.TiposActividad.Where(t => t.NombreTipo == actividad.TipoActividad.Nombre).SingleOrDefault();
//                 if (tipoExistente == null)
//                 {
//                     tipoExistente = new TipoActividadDTO
//                     {
//                         NombreTipo = actividad.TipoActividad.Nombre,
//                         Actividades = new List<ActividadDTO>()
//                     };
//                     fechaExistente.TiposActividad.Add(tipoExistente);
//                 }
//                 var actividadesMostrar = new ActividadDTO
//                 {
//                     Persona = actividad.Persona.Nombre,
//                     DuracionMinutos = (int)actividad.DuracionMinutos.TotalMinutes,
//                     CaloriasQuemadas = (decimal)actividad.DuracionMinutos.TotalMinutes * actividad.TipoActividad.CaloriasPorMinuto

//                 };
//                 tipoExistente.Actividades.Add(actividadesMostrar);
//             }
//             return actividadMostrar.ToList();
